            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="section" class="col-md-4 col-form-label text-md-right">{{ __('แผนก') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="section" type="text"  class="selectpicker form-control" name="section" value="{{ old('section') }}" required autocomplete="section"  data-live-search="true"
                                data-dropup-auto="true" title="กรุณาเลือกแผนก" autofocus >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('username')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>มี User ในระบบแล้ว กรุณากรอกใหม่</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
